...
public sealed class DotCaseNamingPolicyJsonStringEnumConverter : JsonConverterFactory
{
    ...
    public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return (JsonConverter)Activator.CreateInstance(
            ...
            binder: null,
            args: new object?[] { new DotCaseNamingPolicy(), options, knownValues },
            culture: null)!;
    }
...
#pragma warning restore CA2208
        ...
        {
            (string valueFormattedToStr, JsonEncodedText valueEncoded) = CustomEnumConverter<T>.FormatEnumValue(value.ToString(), _namingPolicy, encoder);
